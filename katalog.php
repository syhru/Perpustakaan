...
<body>
    ...
    $table_katalog = mysqli_query($conn, "SELECT * FROM katalog");
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php 
                                ...
                                while($ktg = mysqli_fetch_assoc($table_katalog)) {
                                  
                                    echo "
                                    
                                    <tr>
                                        <td><center>".$ktg['id_katalog']."</center></td>
                                        <td><center>".$ktg['nama']."</center></td>
